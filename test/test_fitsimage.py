...
class FITSImageTest(unittest.TestCase):
    ...
    def mkfits(cls, x_size, y_size, **keywords):
        ...
        kwargs = dict(
            low=cls.MIN_PIXEL_VALUE, high=cls.MAX_PIXEL_VALUE, size=(y_size, x_size)
        )
    ...
    def test_delete_keyword(self):
        ...
        with self.random(**keywords) as img:
            ...
            with warnings.catch_warnings():
                ...
                msg = (
                    "(?s).+ Please update your code so that KeyErrors are "
    ...
    def test_date_and_year(self):
        ...
        keywords = {"DATE-OBS": "2009-06-12T21:12:47.238", "EXPTIME": 1505}
        with self.random(**keywords) as img:
        ...
        keywords = {"DATE-OBS": "1998-11-29T02:53:21", "EXPTIME": 1834}
        with self.random(**keywords) as img:
        ...
        keywords = {"DATE-OBS": "1999-12-31T23:53:12.565", "EXPTIME": 4312.56}
        with self.random(**keywords) as img:
        ...
        keywords = {"DATE-OBS": "2011-06-13", "TIME-OBS": "19:04:28", "EXPTIME": 2341}
        with self.random(**keywords) as img:
        ...
        with self.random(**keywords) as img:
            kwargs = dict(
                date_keyword="DATE", time_keyword="TIME", exp_keyword="EXPOSURE"
            )
        ...
        keywords = {"DATE-OBS": "13/04/20", "TIME-OBS": "22:58:12.1", "EXPTIME": 1328}
        with self.random(**keywords) as img:
        ...
        keywords = {"DATE-OBS": "89/08/30", "TIME-OBS": "01:32:22.14", "EXPTIME": 83.55}
        with self.random(**keywords) as img:
