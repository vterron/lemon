...
.. image:: https://travis-ci.org/vterron/lemon.png?branch=master   :target: https://travis-ci.org/vterron/lemon
...
1. ``apt-get install git python-dev python-pip libfreetype6-dev libpng-dev csh libx11-dev libplplot9``
